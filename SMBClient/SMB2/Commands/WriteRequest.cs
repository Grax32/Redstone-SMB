...
using SMBLibrary.SMB2.Enums.Write;
...
namespace SMBLibrary.SMB2.Commands
{
    ...
    public class WriteRequest : SMB2Command
    {
        ...
        public override void WriteCommandBytes(byte[] buffer, int offset)
        {
            ...
            if (WriteChannelInfo.Length > 0) WriteChannelInfoOffset = SMB2Header.Length + FixedSize;
            DataOffset = 0;
            DataLength = (uint) Data.Length;
            if (Data.Length > 0) DataOffset = (ushort) (SMB2Header.Length + FixedSize + WriteChannelInfo.Length);
